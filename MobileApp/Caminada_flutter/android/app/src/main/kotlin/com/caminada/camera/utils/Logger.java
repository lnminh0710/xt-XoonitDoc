...
import com.caminada.camera.BuildConfig;

public class Logger {

    private static final String TAG = "CAMINADA_ANDROID";
    ...
    public static void Spam() {
        if (BuildConfig.DEBUG) {
            Log.i(TAG, getClassNameMethodNameAndLineNumber() + " spam log");
        }
    }

    /**
     * Get the current line number. Note, this will only work as called from this
     * class as it has to go a predetermined number of steps up the stack trace. In
     * this case 5.
     *
    ...
    /**
     * Get the current method name. Note, this will only work as called from this
     * class as it has to go a predetermined number of steps up the stack trace. In
     * this case 5.
     *
     * @return String - Current line number.
