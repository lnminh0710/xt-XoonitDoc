...
public class PolygonView extends FrameLayout {
    ...
    private void init() {
        ...
        pointer1.setPadding(padding,padding,padding,padding);
        pointer2.setPadding(padding,padding,padding,padding);
        pointer3.setPadding(padding,padding,padding,padding);
        pointer4.setPadding(padding,padding,padding,padding);
        midPointer24
                .setPadding(padding,padding,padding,padding);
        midPointer34.setPadding(padding,padding,padding,padding);
        midPointer12.setPadding(padding,padding,padding,padding);
        midPointer13.setPadding(padding,padding,padding,padding);
        addView(pointer1);
        addView(pointer2);
        addView(pointer3);
        addView(pointer4);
