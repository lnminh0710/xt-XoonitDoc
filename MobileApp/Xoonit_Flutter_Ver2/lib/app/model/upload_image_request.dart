...
class UploadImageRequest {
  ...
  factory UploadImageRequest.fromRawJson(String str) =>
  ...
  factory UploadImageRequest.fromJson(Map<String, dynamic> json) =>
      UploadImageRequest(
        images: List<ImageUpload>.from(
            json["Images"].map((x) => ImageUpload.fromJson(x))),
        scanningLotItemData:
            ScanningLotItemData.fromJson(json["ScanningLotItemData"]),
      );
...
class ImageUpload {
  ...
  ImageUpload({this.fileName, this.pageNr, this.base64String});
...
class ScanningLotItemData {
  ...
  factory ScanningLotItemData.fromRawJson(String str) =>
      ScanningLotItemData.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ScanningLotItemData.fromJson(Map<String, dynamic> json) =>
      ScanningLotItemData(
