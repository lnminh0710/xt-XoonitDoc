    ...
    return Row( 
      ...
      children: <Widget>[
        DropdownButtonHideUnderline(
          ...
          iconDisabledColor: MyColors.blueDropdown,
          iconEnabledColor: MyColors.blueDropdown,
          itemHeight: Dimension.getHeight(1),
    ...
    return Row(
      children: <Widget>[
        CountryPickerUtils.getDefaultFlagImage(country),
          ...
          style: TextStyle(fontSize: 14,color:MyColors.blackColor),)
