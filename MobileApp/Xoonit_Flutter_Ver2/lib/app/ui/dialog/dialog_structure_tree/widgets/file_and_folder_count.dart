...
class FileAndFolderCount extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
          ...
          children: <Widget>[
            hasSubFolder
                ? Container(
                    ...
                    child: Text(
                      fileParentCount < 100
                          ? fileParentCount.toString()
                          : '99+',
                      style: MyStyleText.blue12Bold.merge(TextStyle(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: MyColors.blueLightBackground,
        ...
        decoration: BoxDecoration(
          color: MyColors.blueLightBackground.withOpacity(0.5),
          borderRadius: BorderRadius.circular(100),
          shape: BoxShape.rectangle,
        ));
  }
