...
import 'package:xoonit/app/ui/dialog/dialog_structure_tree/widgets/folder_item.dart';
import 'package:xoonit/app/ui/dialog/dialog_structure_tree/widgets/root_folder_header.dart';
import 'package:xoonit/app/ui/dialog/dialog_structure_tree/widgets/sub_folder_header.dart';
...
class _StructureTreeDialogState extends State<StructureTreeDialog> {
  ...
  void initState() {
    DocumentTreeItem currentFolder = DocumentTreeItem(
        children: XoonitApplication.instance.documentTreeItemList, root: 1);
