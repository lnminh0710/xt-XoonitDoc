...
import static com.xoonit.camera.utils.ConstantsKt.SCANNED_RESULT;
...
//                , XoonitApplication.getInstance().getCurrentDocumentTree().getIDDocumentTree());
        ...
        returnIntent.putExtra(SCANNED_RESULT, ImagePath + "/" + ImageName);
...
//        Intent intent = new Intent(ImageCropActivity.this, CameraContainer.class);
