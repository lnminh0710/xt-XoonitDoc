    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        ...
        if (parameters.getSupportedFocusModes() != null
            ...
            parameters.setFocusMode(Camera.Parameters.FOCUS_MODE_CONTINUOUS_PICTURE);
                ...
                && parameters.getSupportedFocusModes().contains(Camera.Parameters.FOCUS_MODE_MACRO)) {
...
//        stopPreviewAndFreeCamera();
    ...
    private void drawLargestRect(MatOfPoint2f approx, Point[] points, Size stdSize,
                                 int previewArea) {
        Path path = new Path();
    ...
    public void handleFocus(MotionEvent event, Camera.Parameters params) {
        ...
        if (params.getSupportedFocusModes() != null
            ...
            params.setFocusMode(Camera.Parameters.FOCUS_MODE_CONTINUOUS_PICTURE);
                ...
                && params.getSupportedFocusModes().contains(Camera.Parameters.FOCUS_MODE_MACRO)) {
