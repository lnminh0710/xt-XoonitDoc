...
public class CustomListMutilpleAdapter extends ArrayAdapter<ScansImages> implements Filterable {
    ...
    //region Constructors
    CustomListMutilpleAdapter(Activity context, int custom_image_list_Multiple, ArrayList<ScansImages> scanListMutilple) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (row == null) {
            ...
            imageHolder.Bitmap = row.findViewById(R.id.Bitmap);
            imageHolder.imageProperty = row.findViewById(R.id.textImage);
            imageHolder.imageTypeId = row.findViewById(R.id.textType);
            imageHolder.checkBox = row.findViewById(R.id.checkBoxMulti);
        ...
        imageHolder.imageProperty.setText(String.valueOf(scansImagesList.get(position).getPageNr()));
