...
import { SignalRActionEnum, Configuration } from '@app/app.constants';
import { filter, takeUntil } from 'rxjs/operators';
import { CommonService, AppErrorHandler, SignalRService } from '@app/services';

@Component({
    selector: 'indexing-process-popup',
    templateUrl: './indexing-process-popup.component.html',
    styleUrls: ['./indexing-process-popup.component.scss'],
})
export class IndexingProcessPopupComponent extends BaseComponent implements OnInit, OnDestroy {
    constructor(
