...
@Component({
    selector: 'module-search-dialog-customer',
    templateUrl: './module-search-dialog-customer.component.html',
    styleUrls: ['./module-search-dialog-customer.component.scss']
})
export class ModuleSearchDialogCustomerComponent implements OnInit, OnDestroy, AfterViewInit {
