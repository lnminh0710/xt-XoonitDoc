...
describe('AccountDeniedComponent', () => {
    let component: AccountDeniedComponent;
    let fixture: ComponentFixture<AccountDeniedComponent>;
    let store: Store<any>;
    ...
    beforeEach(async(() => {
        TestBed.configureTestingModule({
            ...
            fixture = TestBed.createComponent(AccountDeniedComponent);
