...
import { AccountExpireComponent } from './account-expire.component';
import { UserToken } from '@app/models';

describe('AccountExpireComponent', () => {
    let component: AccountExpireComponent;
    let fixture: ComponentFixture<AccountExpireComponent>;
    let store: Store<any>;
    ...
    beforeEach(async(() => {
        TestBed.configureTestingModule({
            ...
            fixture = TestBed.createComponent(AccountExpireComponent);
    ...
    describe('resendEmail', () => {
        it('resend Email success', () => {
            ...
            spyOn(restService, 'resendEmailNewPass').and.returnValue(of(data));
