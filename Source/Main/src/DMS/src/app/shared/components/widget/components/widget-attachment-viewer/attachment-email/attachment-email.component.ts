...
import { AttachmentViewerService } from '@app/services/form/attachment-viewer.service';
import { TranslateService } from '@ngx-translate/core';
import { Subject } from 'rxjs/internal/Subject';

@Component({
    selector: 'attachment-email',
    templateUrl: './attachment-email.component.html',
    styleUrls: ['./attachment-email.component.scss'],
})
export class AttachmentEmailComponent implements OnInit, OnChanges {
