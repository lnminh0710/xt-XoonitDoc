...
@Component({
    selector: 'xn-material-checkbox-control',
    templateUrl: 'xn-material-checkbox-control.component.html',
    styleUrls: ['xn-material-checkbox-control.component.scss']
})

export class XnMaterialCheckboxControlComponent  extends BaseMaterialControlComponent implements OnInit {
