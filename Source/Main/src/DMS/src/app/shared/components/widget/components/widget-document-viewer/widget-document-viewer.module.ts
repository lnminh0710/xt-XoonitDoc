...
import { WidgetDocumentViewer } from './widget-document-viewer.component';
...
@NgModule({
    ...
    exports: [WidgetDocumentViewer, XnTranslationModule],
    declarations: [WidgetDocumentViewer],
    providers: [],
})
export class WidgetDocumentViewerModule {}
