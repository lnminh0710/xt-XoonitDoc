import { Component, ElementRef, ViewEncapsulation, ViewChild, Renderer2, ChangeDetectorRef, OnDestroy, HostListener } from "@angular/core";
...
export class NgxMyDatePicker implements OnDestroy {
    ...
    constructor(public elem: ElementRef, renderer: Renderer2, private cdr: ChangeDetectorRef, private utilService: UtilService) {
    ...
    onMonthCellClicked(cell: IMyCalendarMonth): void {
        ...
        this.setDateWhenClickOnMonth(cell);
    }
    ...
    onYearCellClicked(cell: IMyCalendarYear): void {
        ...
        this.selectYear = false;
        this.selectorEl.nativeElement.focus();
        this.setDateWhenClickOnYear(cell);
    }
    ...
    onTodayClicked(keyCode?: number): void {
        // Today button clicked
        let today: IMyDate = this.getToday();
        this.selectDate(today, undefined, keyCode);
