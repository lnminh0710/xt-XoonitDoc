...
import {
    ...
    mixinErrorState,
    mixinTabIndex,
} from '@app/shared/components/xn-control/light-material-ui/core';
import {
    MAT_FORM_FIELD,
    MatFormField,
    MatFormFieldControl,
} from '@app/shared/components/xn-control/light-material-ui/form-field';
...
const _MatSelectMixinBase: CanDisableCtor &
    ...
    CanDisableRippleCtor &
    CanUpdateErrorStateCtor &
    typeof MatSelectBase = mixinDisableRipple(mixinTabIndex(mixinDisabled(mixinErrorState(MatSelectBase))));
...
export class MatSelect
    ...
    private _calculateOverlayOffsetY(selectedIndex: number, scrollBuffer: number, maxScroll: number): number {
        ...
        // TAMTV: CUSTOM DISPLAY OPTION
        return Math.round(itemHeight - this._triggerRect.height);
    }
