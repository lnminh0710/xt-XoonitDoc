 ...
 *
 * The {@link PivotEngine} class is responsible for summarizing
 * raw data into pivot views.
 *
 * The {@link PivotPanel} control provides a UI for editing the
 * pivot views by dragging fields into view lists and editing
 * their properties.
 *
 * The {@link PivotGrid} control extends the {@link FlexGrid} to
 * display pivot tables with collapsible row and column
 * groups.
 *
 * The {@link PivotChart} control provides visual representations
