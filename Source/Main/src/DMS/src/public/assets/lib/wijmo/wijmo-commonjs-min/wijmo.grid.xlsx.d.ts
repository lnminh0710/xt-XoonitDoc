...
import * as mTransGrid from 'wijmo/wijmo.grid.transposed';
...
export declare function softTransGrid(): typeof mTransGrid;
/**
...
export declare class FlexGridXlsxConverter {
     ...
     *
     * Once started, the task will be automatically restarted when changes in the grid are detected.
     *
     * @param grid FlexGrid that will be saved.
     * @param options {@link IFlexGridXlsxOptions} object specifying the save options.
     * @param fileName Name of the file that will be generated.
     ...
     *  );</pre>
     */
    static saveAsync(grid: FlexGrid, options?: IFlexGridXlsxOptions, fileName?: string, onSaved?: (base64: string, workbook: mXlsx.Workbook) => any, onError?: (reason?: any) => any, onProgress?: (value: number) => void): mXlsx.Workbook;
    /**
