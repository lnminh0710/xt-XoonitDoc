...
{
    public class CloudSyncBusinessOneDrive : ICloudSyncBusiness
    {
        ...
        public CloudSyncBusinessOneDrive(AppSettings _appSettings)
        {
        ...
        public async Task<bool> TestCloudConnection(CloudConnectionTestModel model)
        {
            ...
            connectionStringModel.SharedFolderId = model.SharedFolderId;
