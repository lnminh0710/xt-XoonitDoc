...
{
    public class InvoiceApprovalService : BaseUniqueServiceRequest, IInvoiceApprovalService
    {
        public InvoiceApprovalService(IOptions<AppSettings> appSettings, IHttpContextAccessor httpContextAccessor, IAppServerSetting appServerSetting) : base(appSettings, httpContextAccessor, appServerSetting)
        {
        }
